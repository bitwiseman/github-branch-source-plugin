  ...
  public void setUpWireMock() throws Exception {
    ...
    githubApi.stubFor(
        post(urlEqualTo("/app/installations/654321/access_tokens"))
            ...
            .willSetStateTo(
                "7") // setting this to non-existant state means any extra requests will fail
            .withRequestBody(
                equalToJson(
                    "{\"permissions\":{\"pull_requests\":\"write\",\"metadata\":\"read\",\"checks\":\"write\",\"contents\":\"read\"}}",
                    true,
  ...
  public void testProviderRefresh() throws Exception {
    ...
    try {
      ...
      GitHub githubInstance =
          createGitHubBuilder(githubApi.baseUrl()).withAuthorizationProvider(provider).build();
  ...
  public void testAgentRefresh() throws Exception {
    ...
    try {
      ...
      final String gitCheckoutStep =
          String.format("    git url: REPO, credentialsId: '%s'", myAppCredentialsId);
